        ...
        <div class="box-body">
          <div class="col-md-12">
            ...
            {!! __form::select_dynamic(
              '3', 'crop_year_id', 'Crop Year', old('crop_year_id'), $global_crop_years_all, 'crop_year_id', 'name', $errors->has('crop_year_id'), $errors->first('crop_year_id'), 'select2', ''
            ) !!}

            {!! __form::select_dynamic(
              '3', 'trader_cat_id', 'Category', old('trader_cat_id'), $global_trader_categories_all, 'trader_cat_id', 'name', $errors->has('trader_cat_id'), $errors->first('trader_cat_id'), 'select2', ''
            ) !!}

            {!! __form::textbox(
              '3', 'control_no', 'text', 'Control No.', 'Control No.', old('control_no'), $errors->has('control_no'), $errors->first('control_no'), 'data-transform="uppercase"'
            ) !!}

            {!! __form::datepicker(
              '3', 'reg_date',  'Date of Registration', old('reg_date') ? old('reg_date') : Carbon::now()->format('m/d/Y'), $errors->has('reg_date'), $errors->first('reg_date')
            ) !!}
            ...
            {!! __form::textbox(
              '6', 'trader_officer', 'text', "Trader's Officer", "Trader's Officer", old('trader_officer'), $errors->has('trader_officer'), $errors->first('trader_officer'), ''
            ) !!}

            {!! __form::textbox(
              '6', 'trader_email', 'text', "Trader's Email", "Trader's Email", old('trader_email'), $errors->has('trader_email'), $errors->first('trader_email'), ''
            ) !!}
